...
- test_acquire_timeout_counts_wait_timeout · function · L155-L171 — async def test_acquire_timeout_counts_wait_timeout(fake_solve)
- _fail · function · L157-L159 — async def _fail(*args, **kwargs)
- TestMainObservability · class · L175-L212 — class TestMainObservability
- test_healthz_has_solver_fields · method · L177-L186 — async def test_healthz_has_solver_fields(self)
- test_metrics_has_solver_lines · method · L189-L204 — async def test_metrics_has_solver_lines(self)
- test_metrics_keeps_legacy_lines · method · L207-L212 — async def test_metrics_keeps_legacy_lines(self)
- test_worker_records_rejected_token · function · L218-L245 — async def test_worker_records_rejected_token(tmp_db, monkeypatch)
- _solve · function · L223-L224 — async def _solve(*a, **k)
- _submit · function · L226-L227 — async def _submit(*a, **k)
