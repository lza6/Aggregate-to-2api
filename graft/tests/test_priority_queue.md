...
- create_request · method · L25-L30 — def create_request(self, task_id, prompt, aspect_ratio, download, request_type, model)
- mark_finished · method · L32-L35 — def mark_finished(self, task_id, status, image_url, error, duration, image_base64=None, image_mime=None)
- mark_started · method · L37-L39 — def mark_started(self, task_id)
- get · method · L41-L42 — def get(self, task_id)
- recover_stale_tasks · method · L44-L45 — def recover_stale_tasks(self) -> int
