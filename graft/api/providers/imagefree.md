...
- ImagefreeProvider · class · L21-L132 — class ImagefreeProvider(Provider)
...
- generate · method · L54-L132 — async def generate(self, model: str, prompt: str, aspect_ratio: str, images: list[bytes] | None = None, resolution: str = "1K", download: bool = False, **kw) -> GenerationResult
